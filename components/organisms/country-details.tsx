...
export const CountryDetails = async ({ slug }: Props) => {
  ...
  const names = (Object.values(country?.name?.nativeName ?? {}) ?? []).map(
    (name) => {
      return name?.common as string;
    },
  );

  const nativeNames = Array.from(new Set(names));
          ...
          <div className="flex flex-col flex-wrap gap-8 md:flex-row lg:gap-4">
            <div className="flex flex-1 flex-col gap-2">
              <dl className="flex flex-row gap-2">
                ...
                <dd className="font-light">{formatter.format(nativeNames)}</dd>
              </dl>
            ...
            <div className="flex flex-1 flex-col gap-2">
              <dl className="flex flex-row gap-2">
                ...
                <dd className="font-light">
                  {hasValues(country?.tld)
                    ? formatter.format(country?.tld)
                    : "None"}
                </dd>
              </dl>
              ...
              <dl className="flex flex-row gap-2">
                ...
                <dd className="font-light capitalize">
                  {country?.car?.side == "left" ? "LH" : "RH"} drive
                </dd>
              </dl>
              ...
              <dl className="flex flex-row gap-2">
                ...
                <dd className="font-light">
                  {formatter.format(country?.timezones)}
                </dd>
              </dl>
